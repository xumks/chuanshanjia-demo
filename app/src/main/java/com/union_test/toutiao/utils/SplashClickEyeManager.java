...
public class SplashClickEyeManager {
    ...
    public ViewGroup startSplashClickEyeAnimationInTwoActivity(
                                                               final ViewGroup splashViewContainer,
                                                               final AnimationCallBack callBack) {
        if (splashViewContainer == null) {
            return null;
        }
        if (mSplashShowView == null) {
            return null;
        }
        return startSplashClickEyeAnimation(mSplashShowView, splashViewContainer, callBack);
    }

    //开屏点睛动画
    public ViewGroup startSplashClickEyeAnimation(final View splash,
                                                  final ViewGroup splashViewContainer,
                                                  final AnimationCallBack callBack) {
        ...
        int animationContainerWidth = splashViewContainer.getWidth();
        int animationContainerHeight = splashViewContainer.getHeight();
        ...
        splashViewContainer.addView(splash, animationParams);
